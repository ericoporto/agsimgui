...
/*	MessageBox(parent,
			 L"agsimgui v0.2.advjam By eri0o",
			 L"About",
...
int AgsImGuiHelper_GetClipboarImage() {
	...
	void AGS_EngineStartup(IAGSEngine *lpEngine)
	{
        ...
        ImVec4 border = ImVec4(0.64f, 0.60f, 0.60f, 1.00f);
        ImVec4 grab = ImVec4(0.69f, 0.69f, 0.69f, 1.00f);
        ImVec4 header = ImVec4(0.86f, 0.86f, 0.86f, 1.00f);
        ImVec4 active = ImVec4(0.90f, 0.47f, 0.64f, 1.00f);
        ImVec4 hover = ImVec4(0.40f, 0.87f, 0.84f, 0.20f);
